    ...
    module Definitions
      module MET
        ...
        timezone 'MET' do |tz|
          ...
          tz.transition 2071, 3, :o1, 3194816400, 59461549, 24
          tz.transition 2071, 10, :o0, 3212960400, 59466589, 24
          tz.transition 2072, 3, :o1, 3226266000, 59470285, 24
          tz.transition 2072, 10, :o0, 3245014800, 59475493, 24
          tz.transition 2073, 3, :o1, 3257715600, 59479021, 24
          tz.transition 2073, 10, :o0, 3276464400, 59484229, 24
          tz.transition 2074, 3, :o1, 3289165200, 59487757, 24
          tz.transition 2074, 10, :o0, 3307914000, 59492965, 24
        end
      end
    end
  end
