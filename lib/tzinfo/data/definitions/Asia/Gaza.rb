      ...
      module Asia
        module Gaza
          ...
          timezone 'Asia/Gaza' do |tz|
            ...
            tz.transition 2040, 10, :o2, 2234304000, 4932895, 2
            ...
            tz.transition 2041, 10, :o2, 2264544000, 4933595, 2
            ...
            tz.transition 2042, 9, :o2, 2295388800, 4934309, 2
            ...
            tz.transition 2043, 9, :o2, 2326233600, 4935023, 2
            ...
            tz.transition 2044, 9, :o2, 2356473600, 4935723, 2
            ...
            tz.transition 2045, 8, :o2, 2387318400, 4936437, 2
            ...
            tz.transition 2046, 8, :o2, 2418163200, 4937151, 2
            ...
            tz.transition 2047, 8, :o2, 2448403200, 4937851, 2
            ...
            tz.transition 2048, 7, :o2, 2479248000, 4938565, 2
            ...
            tz.transition 2049, 7, :o2, 2509488000, 4939265, 2
            ...
            tz.transition 2050, 7, :o2, 2540332800, 4939979, 2
            ...
            tz.transition 2051, 6, :o2, 2571177600, 4940693, 2
            ...
            tz.transition 2052, 6, :o2, 2601417600, 4941393, 2
            ...
            tz.transition 2053, 5, :o2, 2632262400, 4942107, 2
            ...
            tz.transition 2054, 5, :o2, 2663107200, 4942821, 2
            tz.transition 2054, 10, :o1, 2676409200, 59317547, 24
            tz.transition 2055, 5, :o2, 2693347200, 4943521, 2
            tz.transition 2055, 10, :o1, 2708463600, 59326451, 24
            tz.transition 2056, 4, :o2, 2724192000, 4944235, 2
            tz.transition 2056, 10, :o1, 2739913200, 59335187, 24
            tz.transition 2057, 4, :o2, 2754432000, 4944935, 2
            tz.transition 2057, 10, :o1, 2771362800, 59343923, 24
            tz.transition 2058, 4, :o2, 2785276800, 4945649, 2
            ...
            tz.transition 2072, 10, :o2, 3244320000, 4956275, 2
            tz.transition 2072, 10, :o1, 3244921200, 59475467, 24
            tz.transition 2073, 3, :o2, 3257625600, 4956583, 2
            tz.transition 2073, 9, :o1, 3271532400, 59482859, 24
            tz.transition 2073, 10, :o2, 3275164800, 4956989, 2
            tz.transition 2073, 10, :o1, 3276370800, 59484203, 24
            tz.transition 2074, 3, :o2, 3289075200, 4957311, 2
            tz.transition 2074, 8, :o1, 3301772400, 59491259, 24
            tz.transition 2074, 10, :o2, 3306009600, 4957703, 2
            tz.transition 2074, 10, :o1, 3307820400, 59492939, 24
            tz.transition 2075, 3, :o2, 3321129600, 4958053, 2
            tz.transition 2075, 8, :o1, 3332617200, 59499827, 24
            tz.transition 2075, 9, :o2, 3336249600, 4958403, 2
            tz.transition 2075, 10, :o1, 3339270000, 59501675, 24
          end
        end
      end
    end
