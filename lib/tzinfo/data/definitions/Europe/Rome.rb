      ...
      module Europe
        module Rome
          ...
          timezone 'Europe/Rome' do |tz|
            ...
            tz.transition 1866, 12, :o1, -3252098996, 51903665251, 21600
            ...
            tz.transition 2071, 3, :o3, 3194816400, 59461549, 24
            tz.transition 2071, 10, :o2, 3212960400, 59466589, 24
            tz.transition 2072, 3, :o3, 3226266000, 59470285, 24
            tz.transition 2072, 10, :o2, 3245014800, 59475493, 24
            tz.transition 2073, 3, :o3, 3257715600, 59479021, 24
            tz.transition 2073, 10, :o2, 3276464400, 59484229, 24
            tz.transition 2074, 3, :o3, 3289165200, 59487757, 24
            tz.transition 2074, 10, :o2, 3307914000, 59492965, 24
            tz.transition 2075, 3, :o3, 3321219600, 59496661, 24
            tz.transition 2075, 10, :o2, 3339363600, 59501701, 24
          end
        end
      end
    end
