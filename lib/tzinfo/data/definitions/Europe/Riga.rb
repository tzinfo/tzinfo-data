      ...
      module Europe
        module Riga
          ...
          timezone 'Europe/Riga' do |tz|
            ...
            tz.transition 1879, 12, :o1, -2840146584, 8667775559, 3600
            tz.transition 1918, 4, :o2, -1632008184, 8718114659, 3600
            tz.transition 1918, 9, :o1, -1618702584, 8718669059, 3600
            tz.transition 1919, 4, :o2, -1601681784, 8719378259, 3600
            tz.transition 1919, 5, :o1, -1597275384, 8719561859, 3600
            tz.transition 1926, 5, :o3, -1377308184, 8728727159, 3600
