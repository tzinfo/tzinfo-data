      ...
      module Europe
        module Riga
          ...
          timezone 'Europe/Riga' do |tz|
            ...
            tz.transition 2070, 3, :o8, 3163366800, 59452813, 24
            tz.transition 2070, 10, :o3, 3181510800, 59457853, 24
            tz.transition 2071, 3, :o8, 3194816400, 59461549, 24
            tz.transition 2071, 10, :o3, 3212960400, 59466589, 24
            tz.transition 2072, 3, :o8, 3226266000, 59470285, 24
            tz.transition 2072, 10, :o3, 3245014800, 59475493, 24
            tz.transition 2073, 3, :o8, 3257715600, 59479021, 24
            tz.transition 2073, 10, :o3, 3276464400, 59484229, 24
            tz.transition 2074, 3, :o8, 3289165200, 59487757, 24
            tz.transition 2074, 10, :o3, 3307914000, 59492965, 24
            tz.transition 2075, 3, :o8, 3321219600, 59496661, 24
