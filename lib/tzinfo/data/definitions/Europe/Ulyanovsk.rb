      ...
      module Europe
        module Ulyanovsk
          ...
          timezone 'Europe/Ulyanovsk' do |tz|
            ...
            tz.offset :o2, 14400, 0, :'+04/+05'
            tz.offset :o3, 14400, 3600, :'+04/+05'
            tz.offset :o4, 10800, 3600, :'+03/+04'
            tz.offset :o5, 10800, 0, :'+03/+04'
            tz.offset :o6, 7200, 3600, :'+02/+03'
            tz.offset :o7, 7200, 0, :'+02/+03'
            tz.offset :o8, 14400, 0, :'+04'
            ...
            tz.transition 1991, 3, :o6, 670374000
            tz.transition 1991, 9, :o7, 686102400
            tz.transition 1992, 1, :o5, 695779200
            tz.transition 1992, 3, :o4, 701812800
            tz.transition 1992, 9, :o5, 717534000
            ...
            tz.transition 2011, 3, :o8, 1301180400
            tz.transition 2014, 10, :o1, 1414274400
            tz.transition 2016, 3, :o8, 1459033200
          end
        end
      end
    end
