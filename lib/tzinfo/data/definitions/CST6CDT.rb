    ...
    module Definitions
      module CST6CDT
        ...
        timezone 'CST6CDT' do |tz|
          ...
          tz.transition 2069, 3, :o1, 3130128000, 14860895, 6
          tz.transition 2069, 11, :o0, 3150687600, 59449291, 24
          tz.transition 2070, 3, :o1, 3161577600, 14863079, 6
          tz.transition 2070, 11, :o0, 3182137200, 59458027, 24
          tz.transition 2071, 3, :o1, 3193027200, 14865263, 6
          tz.transition 2071, 11, :o0, 3213586800, 59466763, 24
          tz.transition 2072, 3, :o1, 3225081600, 14867489, 6
          tz.transition 2072, 11, :o0, 3245641200, 59475667, 24
          tz.transition 2073, 3, :o1, 3256531200, 14869673, 6
          tz.transition 2073, 11, :o0, 3277090800, 59484403, 24
          tz.transition 2074, 3, :o1, 3287980800, 14871857, 6
          tz.transition 2074, 11, :o0, 3308540400, 59493139, 24
        end
      end
    end
  end
