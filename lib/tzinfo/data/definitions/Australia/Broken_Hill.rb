      ...
      module Australia
        module Broken_Hill
          ...
          timezone 'Australia/Broken_Hill' do |tz|
            ...
            tz.transition 1916, 12, :o4, -1672558200, 38739667, 16
            tz.transition 1917, 3, :o3, -1665387000, 38740995, 16
            tz.transition 1941, 12, :o4, -883639800, 38885763, 16
            tz.transition 1942, 3, :o3, -876123000, 38887155, 16
            tz.transition 1942, 9, :o4, -860398200, 38890067, 16
            tz.transition 1943, 3, :o3, -844673400, 38892979, 16
            tz.transition 1943, 10, :o4, -828343800, 38896003, 16
            tz.transition 1944, 3, :o3, -813223800, 38898803, 16
            ...
            tz.transition 2070, 10, :o4, 3179665800, 39638227, 16
            tz.transition 2071, 4, :o3, 3195390600, 39641139, 16
            tz.transition 2071, 10, :o4, 3211115400, 39644051, 16
            tz.transition 2072, 4, :o3, 3226840200, 39646963, 16
            tz.transition 2072, 10, :o4, 3242565000, 39649875, 16
            tz.transition 2073, 4, :o3, 3258289800, 39652787, 16
            tz.transition 2073, 9, :o4, 3274014600, 39655699, 16
            tz.transition 2074, 3, :o3, 3289739400, 39658611, 16
            tz.transition 2074, 10, :o4, 3306069000, 39661635, 16
            tz.transition 2075, 4, :o3, 3321793800, 39664547, 16
          end
        end
      end
    end
