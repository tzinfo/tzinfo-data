      ...
      module Australia
        module Lord_Howe
          ...
          timezone 'Australia/Lord_Howe' do |tz|
            ...
            tz.transition 2069, 10, :o4, 3148212600, 118897207, 48
            tz.transition 2070, 4, :o2, 3163935600, 19817657, 8
            tz.transition 2070, 10, :o4, 3179662200, 118914679, 48
            tz.transition 2071, 4, :o2, 3195385200, 19820569, 8
            tz.transition 2071, 10, :o4, 3211111800, 118932151, 48
            tz.transition 2072, 4, :o2, 3226834800, 19823481, 8
            tz.transition 2072, 10, :o4, 3242561400, 118949623, 48
            tz.transition 2073, 4, :o2, 3258284400, 19826393, 8
            tz.transition 2073, 9, :o4, 3274011000, 118967095, 48
            tz.transition 2074, 3, :o2, 3289734000, 19829305, 8
            tz.transition 2074, 10, :o4, 3306065400, 118984903, 48
            tz.transition 2075, 4, :o2, 3321788400, 19832273, 8
          end
        end
      end
    end
