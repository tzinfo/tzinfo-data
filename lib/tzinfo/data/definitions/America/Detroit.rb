      ...
      module America
        module Detroit
          ...
          timezone 'America/Detroit' do |tz|
            ...
            tz.transition 2068, 3, :o5, 3098674800, 59434843, 24
            tz.transition 2068, 11, :o2, 3119234400, 9906759, 4
            tz.transition 2069, 3, :o5, 3130124400, 59443579, 24
            tz.transition 2069, 11, :o2, 3150684000, 9908215, 4
            tz.transition 2070, 3, :o5, 3161574000, 59452315, 24
            tz.transition 2070, 11, :o2, 3182133600, 9909671, 4
            tz.transition 2071, 3, :o5, 3193023600, 59461051, 24
            tz.transition 2071, 11, :o2, 3213583200, 9911127, 4
            tz.transition 2072, 3, :o5, 3225078000, 59469955, 24
            tz.transition 2072, 11, :o2, 3245637600, 9912611, 4
            tz.transition 2073, 3, :o5, 3256527600, 59478691, 24
            tz.transition 2073, 11, :o2, 3277087200, 9914067, 4
            tz.transition 2074, 3, :o5, 3287977200, 59487427, 24
            tz.transition 2074, 11, :o2, 3308536800, 9915523, 4
            tz.transition 2075, 3, :o5, 3319426800, 59496163, 24
            tz.transition 2075, 11, :o2, 3339986400, 9916979, 4
          end
        end
      end
    end
