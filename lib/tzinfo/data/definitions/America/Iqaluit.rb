      ...
      module America
        module Iqaluit
          ...
          timezone 'America/Iqaluit' do |tz|
            ...
            tz.transition 2051, 3, :o5, 59285827, 24
            tz.transition 2051, 11, :o3, 9881923, 4
            tz.transition 2052, 3, :o5, 59294563, 24
            tz.transition 2052, 11, :o3, 9883379, 4
            tz.transition 2053, 3, :o5, 59303299, 24
            tz.transition 2053, 11, :o3, 9884835, 4
            tz.transition 2054, 3, :o5, 59312035, 24
            tz.transition 2054, 11, :o3, 9886291, 4
            tz.transition 2055, 3, :o5, 59320939, 24
            tz.transition 2055, 11, :o3, 9887775, 4
            tz.transition 2056, 3, :o5, 59329675, 24
            tz.transition 2056, 11, :o3, 9889231, 4
            tz.transition 2057, 3, :o5, 59338411, 24
            tz.transition 2057, 11, :o3, 9890687, 4
            tz.transition 2058, 3, :o5, 59347147, 24
            tz.transition 2058, 11, :o3, 9892143, 4
            tz.transition 2059, 3, :o5, 59355883, 24
            tz.transition 2059, 11, :o3, 9893599, 4
            tz.transition 2060, 3, :o5, 59364787, 24
            tz.transition 2060, 11, :o3, 9895083, 4
            tz.transition 2061, 3, :o5, 59373523, 24
            tz.transition 2061, 11, :o3, 9896539, 4
            tz.transition 2062, 3, :o5, 59382259, 24
            tz.transition 2062, 11, :o3, 9897995, 4
            tz.transition 2063, 3, :o5, 59390995, 24
