      ...
      module America
        module Vancouver
          ...
          timezone 'America/Vancouver' do |tz|
            ...
            tz.transition 1946, 9, :o1, -733935600, 19456743, 8
            ...
            tz.transition 2071, 3, :o2, 3193034400, 29730527, 12
            tz.transition 2071, 11, :o1, 3213594000, 19822255, 8
            tz.transition 2072, 3, :o2, 3225088800, 29734979, 12
            tz.transition 2072, 11, :o1, 3245648400, 19825223, 8
            tz.transition 2073, 3, :o2, 3256538400, 29739347, 12
            tz.transition 2073, 11, :o1, 3277098000, 19828135, 8
            tz.transition 2074, 3, :o2, 3287988000, 29743715, 12
            tz.transition 2074, 11, :o1, 3308547600, 19831047, 8
            tz.transition 2075, 3, :o2, 3319437600, 29748083, 12
            tz.transition 2075, 11, :o1, 3339997200, 19833959, 8
          end
        end
      end
    end
