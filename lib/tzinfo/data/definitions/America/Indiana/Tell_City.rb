        ...
        module Indiana
          module Tell_City
            ...
            timezone 'America/Indiana/Tell_City' do |tz|
              ...
              tz.transition 1969, 4, :o6, -21484800, 14642033, 6
              ...
              tz.transition 2074, 3, :o2, 3287980800, 14871857, 6
              tz.transition 2074, 11, :o1, 3308540400, 59493139, 24
              tz.transition 2075, 3, :o2, 3319430400, 14874041, 6
              tz.transition 2075, 11, :o1, 3339990000, 59501875, 24
            end
          end
        end
      end
