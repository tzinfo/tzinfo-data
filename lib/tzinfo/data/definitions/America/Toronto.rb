      ...
      module America
        module Toronto
          ...
          timezone 'America/Toronto' do |tz|
            ...
            tz.transition 1949, 11, :o1, -634154400, 9732991, 4
            ...
            tz.transition 2074, 3, :o2, 3287977200, 59487427, 24
            tz.transition 2074, 11, :o1, 3308536800, 9915523, 4
            tz.transition 2075, 3, :o2, 3319426800, 59496163, 24
            tz.transition 2075, 11, :o1, 3339986400, 9916979, 4
          end
        end
      end
    end
