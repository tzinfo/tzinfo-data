      ...
      module America
        module Cambridge_Bay
          ...
          timezone 'America/Cambridge_Bay' do |tz|
            ...
            tz.transition 1972, 4, :o4, 73472400
            tz.transition 1972, 10, :o1, 89193600
            tz.transition 1973, 4, :o4, 104922000
            tz.transition 1973, 10, :o1, 120643200
            tz.transition 1974, 4, :o4, 136371600
            tz.transition 1974, 10, :o1, 152092800
            tz.transition 1975, 4, :o4, 167821200
            tz.transition 1975, 10, :o1, 183542400
            tz.transition 1976, 4, :o4, 199270800
            tz.transition 1976, 10, :o1, 215596800
            tz.transition 1977, 4, :o4, 230720400
            tz.transition 1977, 10, :o1, 247046400
            tz.transition 1978, 4, :o4, 262774800
            tz.transition 1978, 10, :o1, 278496000
            tz.transition 1979, 4, :o4, 294224400
            ...
            tz.transition 1999, 10, :o5, 941356800
            tz.transition 2000, 4, :o6, 954662400
            tz.transition 2000, 10, :o7, 972802800
            tz.transition 2000, 11, :o5, 973400400
            ...
            tz.transition 2069, 3, :o4, 3130131600, 19814527, 8
            tz.transition 2069, 11, :o1, 3150691200, 14862323, 6
            tz.transition 2070, 3, :o4, 3161581200, 19817439, 8
            tz.transition 2070, 11, :o1, 3182140800, 14864507, 6
            tz.transition 2071, 3, :o4, 3193030800, 19820351, 8
            tz.transition 2071, 11, :o1, 3213590400, 14866691, 6
            tz.transition 2072, 3, :o4, 3225085200, 19823319, 8
            tz.transition 2072, 11, :o1, 3245644800, 14868917, 6
            tz.transition 2073, 3, :o4, 3256534800, 19826231, 8
            tz.transition 2073, 11, :o1, 3277094400, 14871101, 6
            tz.transition 2074, 3, :o4, 3287984400, 19829143, 8
            tz.transition 2074, 11, :o1, 3308544000, 14873285, 6
            tz.transition 2075, 3, :o4, 3319434000, 19832055, 8
