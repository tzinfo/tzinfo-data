      ...
      module America
        module Merida
          ...
          timezone 'America/Merida' do |tz|
            ...
            tz.transition 2069, 4, :o3, 3132547200, 14861063, 6
            tz.transition 2069, 10, :o1, 3150082800, 59449123, 24
            tz.transition 2070, 4, :o3, 3163996800, 14863247, 6
            tz.transition 2070, 10, :o1, 3181532400, 59457859, 24
            tz.transition 2071, 4, :o3, 3195446400, 14865431, 6
            tz.transition 2071, 10, :o1, 3212982000, 59466595, 24
            tz.transition 2072, 4, :o3, 3226896000, 14867615, 6
