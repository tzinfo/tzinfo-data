      ...
      module America
        module Moncton
          ...
          timezone 'America/Moncton' do |tz|
            ...
            tz.transition 2069, 3, :o3, 3130120800, 9907263, 4
            tz.transition 2069, 11, :o2, 3150680400, 59449289, 24
            tz.transition 2070, 3, :o3, 3161570400, 9908719, 4
            tz.transition 2070, 11, :o2, 3182130000, 59458025, 24
            tz.transition 2071, 3, :o3, 3193020000, 9910175, 4
            tz.transition 2071, 11, :o2, 3213579600, 59466761, 24
            tz.transition 2072, 3, :o3, 3225074400, 9911659, 4
            tz.transition 2072, 11, :o2, 3245634000, 59475665, 24
            tz.transition 2073, 3, :o3, 3256524000, 9913115, 4
            tz.transition 2073, 11, :o2, 3277083600, 59484401, 24
            tz.transition 2074, 3, :o3, 3287973600, 9914571, 4
            tz.transition 2074, 11, :o2, 3308533200, 59493137, 24
            tz.transition 2075, 3, :o3, 3319423200, 9916027, 4
            tz.transition 2075, 11, :o2, 3339982800, 59501873, 24
          end
        end
      end
    end
