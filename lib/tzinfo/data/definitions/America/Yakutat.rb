      ...
      module America
        module Yakutat
          ...
          timezone 'America/Yakutat' do |tz|
            ...
            tz.transition 2070, 3, :o7, 3161588400, 59452319, 24
            tz.transition 2070, 11, :o6, 3182148000, 29729015, 12
            tz.transition 2071, 3, :o7, 3193038000, 59461055, 24
            tz.transition 2071, 11, :o6, 3213597600, 29733383, 12
            tz.transition 2072, 3, :o7, 3225092400, 59469959, 24
            tz.transition 2072, 11, :o6, 3245652000, 29737835, 12
            tz.transition 2073, 3, :o7, 3256542000, 59478695, 24
            tz.transition 2073, 11, :o6, 3277101600, 29742203, 12
            tz.transition 2074, 3, :o7, 3287991600, 59487431, 24
            tz.transition 2074, 11, :o6, 3308551200, 29746571, 12
            tz.transition 2075, 3, :o7, 3319441200, 59496167, 24
            tz.transition 2075, 11, :o6, 3340000800, 29750939, 12
          end
        end
      end
    end
