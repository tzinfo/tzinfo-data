      ...
      module America
        module Monterrey
          ...
          timezone 'America/Monterrey' do |tz|
            ...
            tz.transition 2066, 4, :o2, 3037593600, 14854469, 6
            tz.transition 2066, 10, :o1, 3055734000, 59422915, 24
            tz.transition 2067, 4, :o2, 3069043200, 14856653, 6
            tz.transition 2067, 10, :o1, 3087183600, 59431651, 24
            tz.transition 2068, 4, :o2, 3100492800, 14858837, 6
            tz.transition 2068, 10, :o1, 3118633200, 59440387, 24
            tz.transition 2069, 4, :o2, 3132547200, 14861063, 6
            tz.transition 2069, 10, :o1, 3150082800, 59449123, 24
            tz.transition 2070, 4, :o2, 3163996800, 14863247, 6
            tz.transition 2070, 10, :o1, 3181532400, 59457859, 24
            tz.transition 2071, 4, :o2, 3195446400, 14865431, 6
            tz.transition 2071, 10, :o1, 3212982000, 59466595, 24
            tz.transition 2072, 4, :o2, 3226896000, 14867615, 6
            tz.transition 2072, 10, :o1, 3245036400, 59475499, 24
          end
        end
      end
    end
